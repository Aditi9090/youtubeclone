...
import LoginandRegistor from "./Components/LoginandRegistor/LoginandRegistor";
...
const[RegistortoLogin, setRegistortoLogin] = useState(true);
  ...
  return (
   ...
   <Router>
      ...
      {RegistortoLogin && <LoginandRegistor  setRegistortoLogin={setRegistortoLogin}/>}
