...
import { AiFillDislike, 
    AiOutlineDislike, 
    AiFillLike,
    AiOutlineLike } from "react-icons/ai";
import { RiHeartAddFill, 
    RiPlayListAddFill,
    RiShareForwardLine } from "react-icons/ri";
import "./LikeWatchLaterSaveßtns.css";
    ...
    return (
        <div className="btns_cont_videoPage">
            ...
            >
                    {LikeBtn ? (
                        <>
                        <AiFillLike size={22} className="btns_videoPagePage"/>
                        </>
                        ):(
                        <>
                        <AiOutlineLike size={22} className="btns_videoPagePage"/>
                        </>
                    )}
                    <b>{vv.Like}</b>
            ...
            onClick={(e)=>toggleDislikeBtn(e, vv.Like)}>
                ...
                onClick={()=>toggleSavedVideo()}>
                    {SAveVideo?(
                        ...
                        <>
                        <MdPlaylistAddCheck size={22} className="btns_vid"/>
                        <b>Saved</b>
                        </>
                    )}
                </div>
